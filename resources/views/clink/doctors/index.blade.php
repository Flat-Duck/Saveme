    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <a class="pull-right btn btn-sm btn-primary" href="{{ route('clink.doctors.create') }}">
                    إضافة جديد
                </a>
            </div>
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    @forelse ($doctors as $doctor)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('clink.doctors.edit', ['doctor' => $doctor->id]) }}">
                                    <i class="fa fa-pencil-square-o"></i>
                                </a>

                                <form action="{{ route('clink.doctors.destroy', ['doctor' => $doctor->id]) }}"
                                    method="POST"
